...
const pkgdef :Spk.PackageDefinition = (
  ...
  id = "acf22s3szdfpuycu76u1cg3da758mtaznge1dsrj35u2whqszdp0",
  ...
  manifest = (
    ...
    metadata = (
      ...
      codeUrl = "https://github.com/FreshRSS/FreshRSS",
      # URL of the app's source code repository, e.g. a GitHub URL.
      # Required if you specify a license requiring redistributing code, but optional otherwise.

      license = (openSource = agpl3), # this is AFFERO, not real gpl...
      ...
      author = (
        ...
        contactEmail = "jonathan.schemoul@gmail.com",
      ...
      shortDescription = (defaultText = "A simple RSS reader, quite fun to use."),
